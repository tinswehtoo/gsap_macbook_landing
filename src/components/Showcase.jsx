          ...
          <div className="lg:max-w-md">
            ...
            <div className="space-y-5 mt-7 pe-10">
              ...
              <p>
                ...
                unbeliveably thin, light and powerful.
              </p>
              <p>
                A brand-new displays engine delivers breathtaking precision,
                color accuracy, and brightness. And a next-gen GPU with
                hardware-acclerated ray tracing brings console-level graphics to
                your fingertips.
              </p>
